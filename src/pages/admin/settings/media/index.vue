<template>
  <div class="max-w-4xl mt-12 md:mt-24 mx-auto grid items-center justify-center grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="flex flex-col">
      ...
      />
      <label class="text-lg text-gray-500" for="email">System Email</label>
      <input
        type="email"
        name="email"
        id="email"
        class="bg-gray-200 rounded-lg shadow-sm px-2 py-3 my-2 focus:ring-green-700 focus:outline-green-700"
        v-model="settings.otp_email"
      />
...
<script setup>
  ...
  const getSettings = () => {
    axios
      ...
      .then((res) => {
        ...
        settings.value.otp_email = res.data.setting.otp_email
  ...
  const updateSettings = () => {
    ...
    formData.append('otp_email', settings.value.otp_email)
