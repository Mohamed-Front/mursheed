...
const show = (id) => {
    router.push({ name: 'ticket-show', params: { id: id } })
    console.log(id)
  }
  const close =(id)=>{

    axios.get(`api/tickets/inActiveTicket/${id}`).then((res) => {
...
const fetchData = () => {
  ...
  axios.get("api/tickets").then((res) => {
    loading.value = false
    elements.value = res.data.tickets
    ...
    <div class="col-12">
      <va-card class="card">
        ...
        >
          ...
          <Column field="number" header="Ticket Id" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data?.number }}
            </template>
          </Column>

          <Column field="title" header="Subject" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
          ...
          <Column field="status" header="Status" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              ...
              <Tag :value="slotProps.data.status==1?'Active':slotProps.data.status==0?'Closed':'pending'" :severity="getSeverity(slotProps.data)" />

            </template>
          </Column>
          <Column field="title" header="Created At" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{  moment(slotProps.data.user.created_at).format('DD-MM-YYYY')}}
